...
- You can make an extractor _optional_. `Option<my extractor>` lets you still match the route if an extraction wasn't provided.
...
We'll deal with _extensions_ next.

> [Next](/07-RustService/simple_tower_layer.md)
