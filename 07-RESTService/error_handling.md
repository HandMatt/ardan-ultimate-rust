...
But what if you want to display more detail in your error message? Axum let's you define _tuples_ for your errors---containing various parts of the response (you can apply headers with `HeaderMap`, for example). Here's a simple example:
...
> [Next](/07-RESTService/error_handling_recap.md)
