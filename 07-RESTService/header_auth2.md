...
That's an improvement---all authentication is now self-contained. It's still really messy to require that the handler _also_ look at the headers and obtain the data. The good news is that we can fix that, too.

> [Next](/07-RESTService/header_auth3.md)
