...
pin_project! {
    /// A stream that converts every line to uppercase
    struct ToUpper {
        #[pin]
...
impl tokio_stream::Stream for ToUpper {
    ...
    /// Convert every line to uppercase
    fn poll_next(
...
async fn handler() -> impl IntoResponse {
    ...
    // convert the `AsyncRead` into a buffered reader, then a line stream, then you adapter
