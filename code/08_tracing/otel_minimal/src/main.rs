...
///
/// The `resource` is set to a service named "hello_world".
///
/// The `with_endpoint` method is used to specify the OTLP gRPC endpoint.
///
...
/// Initialize OpenTelemetry metrics with an OTLP exporter.
///
/// The `resource` is set to a service named "hello_world".
///
/// The `with_endpoint` method is used to specify the OTLP gRPC endpoint.
...
/// Initialize OpenTelemetry logs with an OTLP exporter.
///
/// The `resource` is set to a service named "hello_world".
///
/// The `with_endpoint` method is used to specify the OTLP gRPC endpoint.
